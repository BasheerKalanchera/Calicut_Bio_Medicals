...
from app.domains.reference import catalog_router as catalog_reference_router
from app.domains.reference import router as reference_router
from app.domains.reporting import router as reporting_router
...
def _register_routers(application: FastAPI) -> None:
    ...
    application.include_router(catalog_reference_router.router, prefix="/api/v1")
