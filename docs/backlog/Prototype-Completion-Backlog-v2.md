# Prototype Completion Backlog v2

## Summary

* **Total Backlog Items:** 22
* **P1 Critical Count:** 12
* **P2 High Count:** 5
* **P3 Medium Count:** 5
...
* **Description:** Add support for basic customer hierarchy. Enables defining customer type and linking a customer profile to a parent customer, displaying this relationship in the Customer 360 profile view.
* **Prototype Change Required:** New fields on customer profile form for Customer Type and Parent Customer; display of parent relationship link within Customer 360 view. (Exclude hierarchy management workspace, nested customer directory tree, and advanced hierarchy administration).
* **Acceptance Criteria:**
  * User can define Customer Type (e.g., Corporate Group, Hospital, Department)
  * User can select and link a Parent Customer for a customer profile
  * Customer 360 profile view displays the linked parent relationship
* **Dependencies:** None
...
* **Source:** REC-19
* **Business Area:** Activity Management
* **Description:** Add search capabilities for historic interaction summaries to leverage past communication context. Search can be integrated directly within the Customer 360 view, Activity Management dashboard, or Global Search.
* **Prototype Change Required:** Integrate search filter bar inside Customer 360 or Activity tabs to search interaction records. Remove dedicated Knowledge Repository module, dedicated Knowledge Repository screen, and sidebar navigation entry.
* **Acceptance Criteria:**
  * User can search interaction summaries by Keyword
  * User can filter/search interactions by Customer name
  * User can filter/search interactions by Product category
  * User can filter/search interactions by Competitor
* **Dependencies:** PB-010
* **Priority:** P2 High
...
* **Dependencies:** PB-002, PB-004, PB-005, PB-018
* **Priority:** P2 High
...
13. **PB-006 – Salesperson Dashboard Metrics** (P2 High)
14. **PB-007 – Manager Dashboard Metrics** (P2 High)
15. **PB-008 – GM Dashboard & Role** (P2 High)
16. **PB-019 – Operational Reports Library** (P2 High)
...
17. **PB-011 – Customer Status & Tiering** (P3 Medium)
18. **PB-012 – Customer Profile Contact Details** (P3 Medium)
19. **PB-013 – Stakeholder Influence & Role Assessment** (P3 Medium)
20. **PB-015 – OEM Profiles Management** (P3 Medium)
21. **PB-016 – Feedback Collection Workspace** (P3 Medium)
22. **PB-017 – Searchable Interaction History** (P2 High)
...
* **Source:** Implementation-Deferred-From-Prototype.md (PRD Section 7 / Phase 1 Requirements List)
* **Description:** Administration dashboard and capabilities for managing user profiles, roles, and system access.
* **Reason Deferred:** Not required for Prototype Freeze.
* **Action Required:** Must be considered during ERD, API Design, Security Design, and SDD.

---

### DF-002 – Master Data Administration
* **Source:** Implementation-Deferred-From-Prototype.md (Derived from Product, Territory, and Governance requirements)
* **Description:** Interface and management controls for Master Data tables (Product Catalog master, Zones, and territory lists).
* **Reason Deferred:** Not required for Prototype Freeze.
* **Action Required:** Review during SDD preparation.
