...
next step only" rule (second time — see Process-Rules-History 2026-09-24).
Everything below was cut from it unchanged; any still-open item was kept
there as a one-line pointer. Section headings are demoted one level.
