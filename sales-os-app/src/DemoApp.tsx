...
export default function DemoApp() {
  ...
  const [pipelineInitialFilter, setPipelineInitialFilter] = useState<
    | { ownerId?: string; zoneId?: string; sbuId?: string; productId?: string; brandId?: string; tradeInsOnly?: boolean; closedFrom?: string; closedTo?: string; statusId?: string; stageId?: string; label: string }
    | undefined
  >(undefined);
